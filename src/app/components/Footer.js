        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="mt-4 space-y-4">
              ...
              <li><a className="text-base text-gray-300 hover:text-white" href="#">Contact</a></li>
          ...
          <div className="col-span-2 md:col-span-2">
            <div className="flex items-center gap-3 text-white mb-4">
              ...
              <h2 className="text-xl font-bold tracking-tight">StudyHub</h2>
            </div>
            <p className="text-base text-gray-400">© 2024 StudyHub. All rights reserved.</p>
